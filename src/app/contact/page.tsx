  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#111827] to-[#1e293b] text-white overflow-hidden relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-6">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-xl mb-2">
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14  mt-4 rounded-2xl bg-emerald-500/20 flex items-center justify-center border border-emerald-500/20">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14 mt-4 rounded-2xl bg-cyan-500/20 flex items-center justify-center border border-cyan-500/20">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14  mt-4 rounded-2xl bg-pink-500/20 flex items-center justify-center border border-pink-500/20">
        ...
        {/* <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.7 }}
            className="rounded-3xl border h-[545px] border-white/10 bg-white/5 backdrop-blur-2xl p-8 shadow-2xl"
          >
            ...
            <form className="space-y-2">
              <div>
                ...
                <input
                  ...
                  className="w-[500px] h-[45px] bg-white/5 border border-white/10 rounded-2xl px-5 py-4 outline-none focus:border-emerald-400 transition placeholder:text-white/30"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-[500px] h-[85px] bg-white/5 border border-white/10 rounded-2xl px-5 py-4 outline-none focus:border-emerald-400 transition placeholder:text-white/30 resize-none"
                />
              </div>

              <button
                type="submit"
                className="w-[160px] bg-emerald-500 hover:bg-emerald-600 active:scale-[0.98] transition-all duration-200 py-4 rounded-2xl font-semibold flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/20"
              >
                <Send size={18} />
                Send Message
              </button>
